...
Evaluation count : 60482070 in 6 samples of 10080345 calls.
             Execution time mean : 8.254094 ns
    Execution time std-deviation : 0.362106 ns
   Execution time lower quantile : 7.547853 ns ( 2.5%)
   Execution time upper quantile : 8.492824 ns (97.5%)
                   Overhead used : 1.804565 ns
