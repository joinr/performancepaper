...
The author sought to establish a microbenchmark comparison between simple java
...
setting `*uncheked-math*` to true for the scope of the body, then reverting to
